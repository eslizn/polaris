...
class Stream implements StreamInterface
{
     ...
     *
     * @throws Exception If argument is not a resource.
     */
     ...
     *
     * @throws Exception If argument is not a valid PHP resource.
     */
    protected function attach($newStream)
    {
        if (is_resource($newStream) === false) {
            throw new Exception(__METHOD__ . ' argument must be a valid PHP resource');
        }
    ...
    public function isPipe(): bool
    {
        if ($this->isPipe === null) {
            ...
            if ($this->isAttached()) {
                ...
                $this->isPipe = ($mode & static::FSTAT_MODE_S_IFIFO) !== 0;
            }
        }
